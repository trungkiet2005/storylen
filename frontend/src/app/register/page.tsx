        ...
        <div style={{ width: "100%", maxWidth: 440 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div>
              ...
              />
              {fieldErrors.username ? <div style={{ color: "var(--accent)", fontSize: 11, marginTop: 5 }}>{fieldErrors.username}</div> : null}
            </div>
            ...
            <div>
              ...
              />
              {fieldErrors.email ? <div style={{ color: "var(--accent)", fontSize: 11, marginTop: 5 }}>{fieldErrors.email}</div> : null}
            </div>
            ...
            <div>
              ...
              {fieldErrors.password ? <div style={{ color: "var(--accent)", fontSize: 11, marginTop: 5 }}>{fieldErrors.password}</div> : null}
            </div>
            ...
            <div>
              ...
              />
              {fieldErrors.confirm ? <div style={{ color: "var(--accent)", fontSize: 11, marginTop: 5 }}>{fieldErrors.confirm}</div> : null}
            </div>
            ...
            <div>
              ...
              {fieldErrors.agreed ? <div style={{ color: "var(--accent)", fontSize: 11, marginTop: 5 }}>{fieldErrors.agreed}</div> : null}
            </div>
