...
\hspace{0.7cm}\begin{minipage}{0.86\paperwidth}
  ...
  \begin{tabular}{@{}p{3.35cm}p{3.35cm}p{3.35cm}p{3.35cm}@{}}
    ...
    {\color{white}CSC10011 — CNPM cho hệ thống AI} & {\scriptsize\color{white}GS.TS Nguyễn Văn Vũ\newline ThS. Trương Phước Lộc\newline ThS. Ngô Ngọc Đăng Khoa} & {\color{white}Nhóm 1 — StoryLens} & {\color{white}10/07/2026 · HCMUS}\\
...
{\color{gold}\headfont\bfseries NHÓM} & {\scriptsize\color{white}Nhóm 1 — CSC10011 · GVHD: GS.TS Nguyễn Văn Vũ, ThS. Trương Phước Lộc, ThS. Ngô Ngọc Đăng Khoa}\\
\end{tabular}
\end{minipage}
\end{frame}}
